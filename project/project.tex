...
\newcommand{\assignment}{Modeling Accelerator-Driven Sub-Critical Systems}
...
exercises as well as contribution to the EINSTEIN project, focused on 
Accelerator Driven Subcritical System modeling and simulation. This work will 
include data collection, collaboration, and potential code contributions to 
tools in the Cyclus ecosystem. \textbf{For 1 credit hour, the student should 
...
The primary work will be to support new work on developing models for 
Accelerator Driven Subcritical system targets and their transmutation under 
bombardment.  This work will begin with research and data collection, with the 
possibility of developing user-friendly code contributions for use in Cyclus 
ecosystem modules. 
...
repositories at \href{github.com/arfc}{github.com/arfc}. 
...
\begin{itemize}
        ...
        \item collaborative code development toward an ADS model in Cyclus,
